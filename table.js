	...
	var Table = function(JsonData){
		...
		this.ghead = function(){
			...
			for(var i = 0;i<headData.length;i++){
				$("<td>"+headData[i]+"</td>").appendTo($headTr);	
			}
		...
		this.gCloumn = function(JsonData){
			...
			var $myCTable = $("<table class='table table-bordered'></table>");
